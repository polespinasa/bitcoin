...
//! A word's position in this list is its 11-bit index used for entropy and
//! checksum encoding. The list is sorted in alphabetical order.
//! Do NOT change words order.
constexpr std::array<std::string_view, 2048> ENGLISH_WORDLIST{
