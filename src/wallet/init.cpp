...
void WalletInit::AddWalletOptions(ArgsManager& argsman) const
{
    ...
    argsman.AddArg("-test_coinselection_bump_fee_sleep=<ms>", "Sleep for <ms> milliseconds during coin selection between individual and combined bump fee calculations. Used for testing race conditions (default: 0)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::WALLET_DEBUG_TEST);
