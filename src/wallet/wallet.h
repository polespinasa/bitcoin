...
public:
    ...
    util::Expected<std::pair<CExtKey, KeyOriginInfo>, WalletError> DeriveHDKey(const std::vector<uint32_t>& path, std::optional<CExtPubKey> xpub) const EXCLUSIVE_LOCKS_REQUIRED(cs_wallet);
