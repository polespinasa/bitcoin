...
ImportDescriptorResult ImportDescriptor(CWallet& wallet, const ImportDescriptorRequest request, int64_t timestamp) EXCLUSIVE_LOCKS_REQUIRED(wallet.cs_wallet)
{
